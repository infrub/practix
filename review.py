...
def create_ax(ashi):
    ...
    if ashi == "m05":  
        candle_axs[ashi].scatter(buy_order_df.entryX+0.25, buy_order_df.entryPrice,s=50,c='#ff4444',marker='>',edgecolors="#ffffff", label="INVIS_LABEL")
        candle_axs[ashi].scatter(buy_order_df.exitX-0.25, buy_order_df.exitPrice,s=50,c='#ff4444',marker='<',edgecolors="#ffffff", label="INVIS_LABEL")
        candle_axs[ashi].scatter(sell_order_df.entryX+0.25, sell_order_df.entryPrice,s=50,c='#4444ff',marker='>',edgecolors="#ffffff", label="INVIS_LABEL")
        candle_axs[ashi].scatter(sell_order_df.exitX-0.25, sell_order_df.exitPrice,s=50,c='#4444ff',marker='<',edgecolors="#ffffff", label="INVIS_LABEL")
